...
(function() {
  var boxes, bufferSize, calFullHeight, calHeight, calWidth, cutBox, cuts, generateConvert, i, j, len, lineWidth, loadTemplate, metrics, selectedBox, templates;
  ...
  cutBox = function(boxes, arg) {
    var bottom, box, box1, box2, h, left, pri, priH, priW, ref, right, top, w, x, y;
    box = arg.box, top = arg.top, left = arg.left, bottom = arg.bottom, right = arg.right;
  ...
  for (i = j = 0, len = templates.length; j < len; i = ++j) {
    ...
    templates[i] = boxes.map(function(arg) {
      var h, w, x, y;
